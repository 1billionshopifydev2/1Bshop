  ...
  height: 300px;
      ...
      <main class="main">
        <div class="container">
            ...
            <div class="row">
              ...
              <div class="col-12 col-lg-6 product__info">
                ...
                <div class="row">
                  ...
                  <div class="col product__info--manufacturer">House my Brand</div>
                </div>
                <div class="product__info--options">
                  ...
                  <div class="product__info--options-item">
                    <div class="option-title">
                      Size:{' '}
                      <span class="size-modal-link" data-bs-toggle="modal" data-bs-target="#sizeModal">
                        See size table
                      </span>
                    </div>
                ...
                <div class="product__info--btns">
                  <div class="product__info--qty">
                    ...
                    <div class="input-group">
                      <button class="btn btn-outline-secondary btn-minus" type="button" id="minus">
                        -
                      </button>
                      <input type="text" class="form-control" value="1" />
                      <button class="btn btn-outline-secondary btn-plus" type="button" id="plus">
                        +
                      </button>
                    </div>
                  </div>
                ...
                <div class="tab-pane fade show active" id="desc-tab-pane" role="tabpanel" aria-labelledby="desc-tab" tabindex="0">
                  <div class="row">
                    <div class="col-12 col-lg-7 desc-details">
                      <div class="desc-title">Details and product description</div>
                      <div class="desc-text">
                    ...
                    <div class="col-12 col-lg-5 desc-materials">
                      <div class="desc-title">Material(s) and care</div>
                      <div class="desc-text">
                    ...
                    <div class="col-12 col-lg-6">
                      <div class="review__item">
                        ...
                        <div class="review__item--text">
                          ...
                          <div class="review__item--desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>
                        </div>
                      </div>
                      <div class="review__item">
                        <div class="review__item--img">
                        ...
                        <div class="review__item--text">
                          ...
                          <div class="review__item--desc">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem</div>
                        </div>
                      </div>
                      <div class="review__item">
                        <div class="review__item--img">
            ...
            <div class="swiper product__list">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide product__item">
                  ...
                  <div class="product__item--price">$119.99</div>
                </div>
                <div class="swiper-slide product__item">
                  <div class="product__item--image">
                    <a href="#">
                  ...
                  <div class="product__item--price">$79.99</div>
                </div>
                <div class="swiper-slide product__item">
                  <div class="product__item--image">
                    <a href="#">
          ...
          <div class="sibscribe">
            <div class="row">
              <div class="col-12 col-lg-5 sibscribe__desc">Subscribe to our newsletter and receive exclusive offers every week</div>
